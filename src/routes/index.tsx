    ...
    <>
      ...
      <section class="mb-4">
        ...
        <div class="p-4 rounded-lg rounded-t-none border-2 border-neutral-200 border-t-0">
          <ul>
            <li>6/23/2025: Waiting on Cherry Blend to come in for Larry Williams (see waitlist)</li>
            <li>6/21/2025: John Doe did pay his outstanding balance (okay to sign again.)</li>
      ...
      <section class="mb-4">
        ...
        <div class="p-4 rounded-lg rounded-t-none border-2 border-neutral-200 border-t-0">
          <ul>
            <li>5/22/2025: Larry Williams | 2PL 4x4 Cherry Blend | 555-627-1255</li>
            <li>5/30/2025: Tina Lybeck | 1PL Med Mossy Boulders | 555-631-2479</li>
            <li>6/16/2025: Connor Lebobby | 4yds Red Mulch | 555-473-6448</li>
            <li>6/20/2025: Mila O'Reilly | ?yds Oversize Blue/White | 555-497-1489</li>
          </ul>
        </div>
      </section>
    </>
